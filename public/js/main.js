...
function populatePortfolio(data) {
    // Hero Section
    if (data.hero) {
        document.querySelector('#home .text-5xl').textContent = data.hero.title;
        document.querySelector('#home .text-2xl').innerHTML = data.hero.subtitle;
    }

    // About Me Section
    if (data.about) {
        document.querySelector('#about .text-lg').innerHTML = data.about.description;
    }
